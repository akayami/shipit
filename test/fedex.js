...
const {FedexClient} = require('../lib/fedex');
...
describe("fedex client", function() {
  ...
  describe("requestOptions", function() {
    ...
    before(function() {
      ...
      return _options = _fedexClient.requestOptions({trackingNumber: '1ZMYTRACK123', reference: 'zappos'});
    });
    ...
    it("uses the correct URL", () => _options.uri.should.equal('https://ws.fedex.com/xml'));
